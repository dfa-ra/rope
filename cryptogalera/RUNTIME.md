...
Mode is **STABILIZATION**. D-005 A is done. Last ship is **v0.3.4**. Every completed product task ends with PR → review → merge to `main` → tagged release. Do not invent iOS/ratchet/landing. No VK/Yandex/WB tunnels. Do not retag v0.2.15 / v0.3.0 / v0.3.1 / v0.3.2 / v0.3.3 / v0.3.4.
