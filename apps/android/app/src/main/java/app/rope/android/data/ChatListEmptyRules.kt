...
object ChatListEmptyRules {
    ...
    fun copy(
        ...
        val title = when (mode) {
            ...
            ChatListMode.MUTED -> ChatListRules.EMPTY_MUTED
        ...
        val body = when {
            ...
            mode == ChatListMode.MUTED -> ChatListRules.EMPTY_MUTED_BODY
    ...
    fun searchBody(mode: ChatListMode, query: String): String {
        ...
        val noun = when (mode) {
            ...
            ChatListMode.ALL, ChatListMode.MUTED, ChatListMode.ARCHIVE -> "чатов"
        }
