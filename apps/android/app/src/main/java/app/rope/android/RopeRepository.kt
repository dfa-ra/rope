...
class RopeRepository(private val app: Application) {
        ...
        scope.launch {
            try {
                ...
                _state.value = _state.value.copy(
                    ...
                    captionAbove = store.captionAbove(),
                )
    ...
    fun toggleCaptionAbove() {
        val next = !_state.value.captionAbove
        store.saveCaptionAbove(next)
        _state.value = _state.value.copy(captionAbove = next)
    }
