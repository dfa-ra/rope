...
class LocalStore(context: Context) : SQLiteOpenHelper(context, "rope-local.db", null, VERSION) {
    ...
    fun saveQuietHours(id: String) {
        put(QuietHoursRules.KEY, QuietHoursRules.normalize(id))
    }

    fun quietHours(): String = QuietHoursRules.normalize(get(QuietHoursRules.KEY))
