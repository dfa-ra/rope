        ...
        setContent {
            ...
            RopeTheme(mode = state.theme) {
                RopeScaffold(
                    ...
                    onSelectFolder = repo::selectFolder,
                    onHideUnreadFolder = repo::hideUnreadFolder,
                    onShowUnreadFolder = { show -> if (show) repo.showUnreadFolder() else repo.hideUnreadFolder() },
                    onCreateFolder = repo::createFolder,
                    onRenameFolder = repo::renameFolder,
                    onDeleteFolder = repo::deleteFolder,
                    onMoveFolder = repo::moveFolder,
                    onCycleFolderChat = repo::cycleFolderChat,
                    onSetChatFolders = repo::setChatFolders,
