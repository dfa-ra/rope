...
- Cached ICE unwrap failure (Keystore miss / corrupt wrap) does not fall back to public Google or Cloudflare STUN.
...
- Per-device WSS RING and RELAY are limited (6 / 30s each). Offer/answer/ICE/accept/hangup are not throttled at that cap.
