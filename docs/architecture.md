...
2. Installer creates a system user, self-signed TLS cert, `setup_token`, systemd unit, and a health endpoint.
...
- **Transport**: TLS protects the channel. E2EE protects content from the server.
