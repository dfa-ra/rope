...
- Hold a playing voice note for 2x until release. LocalStore stays v6.
- Saved Messages chip **Голосовые** filters the Избранное thread to live voice notes even when search is closed. Distinct from Saved kind chips Все / Фото / Файлы / Ссылки. LocalStore stays v6.
