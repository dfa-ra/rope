...
- **0.3.51:** long-press-drag a TEXT/GROUP_TEXT span in the message menu and «Копировать» copies that excerpt (full body still copies when nothing is highlighted). Not the reply quote-span picker. LocalStore stays v6.
