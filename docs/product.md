...
- **0.3.51 UI:** 1:1 peer profile lists shared HTTPS links from bubble text or packed `lp`. Tap jumps to the bubble in chat. Distinct from Saved chips. LocalStore stays v6.
