...
- **0.3.51 UI:** opening a chat always keeps Чаты (or the list you came from) under the thread so Back does not exit; the chat header shows Назад. LocalStore stays v6.
