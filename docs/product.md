...
The product trunk is **`main`**, shipping **0.3.3**. GitHub Releases `v0.2.15`, `v0.3.0`, `v0.3.1`, and `v0.3.2` remain published history.

| Line | What it is |
| --- | --- |
| **`main`** | Shipped tree: Android `versionName=0.3.3` / `versionCode=27`, plus CryptoGalera operating layer |
...
| **GitHub Release `v0.3.2`** | Previous Latest until `v0.3.3` publishes. Do not retag `v0.3.2`. |
...
1. Install the Android app (this cycle ships `v0.3.3`).
