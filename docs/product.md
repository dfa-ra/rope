...
- **0.3.51 UI:** Settings «Не доставать из архива» keeps archived chats in Archive on new mail. Default on (`keep_arch` != `"0"`). Off returns the chat to the main list. Not envelope crypto.
