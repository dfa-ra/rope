...
- In-thread video mini-player: a floating player stays up outside that thread while a clip is playing or paused. Not the call overlay (no CallVideoRenderer). LocalStore stays v6.
