...
| **GitHub Release `v0.3.47`** | Previous Latest until `v0.3.48` publishes. Do not retag `v0.3.47`. |
...
1. Install the Android app (this cycle ships `v0.3.48`).
