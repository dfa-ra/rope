...
| **GitHub Release `v0.3.44`** | Previous Latest until `v0.3.45` publishes. Do not retag `v0.3.44`. |
...
1. Install the Android app (this cycle ships `v0.3.45`).
