...
| **GitHub Release `v0.3.48`** | Previous Latest until `v0.3.49` publishes. Do not retag `v0.3.48`. |
...
1. Install the Android app (this cycle ships `v0.3.49`).
