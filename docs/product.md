...
- A single gallery video within the кружок duration cap can send as a round video note (`video_note`). Album/multi-select stays regular video. LocalStore stays v6.
