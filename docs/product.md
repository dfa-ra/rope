...
- Saved Messages chip **Видео** filters Избранное to live videos even when search is closed. Distinct from Saved kind chips and Голосовые. LocalStore stays v6.
