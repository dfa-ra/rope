...
- **0.3.51 UI:** Settings «Звук уведомлений» sets the message channel tone (Стандарт / Рингтон / Нет). Shade only — not in-app beep, not call ringtone. LocalStore stays v6.
