...
- Attach sheet **Трансляция** sends a live OpenStreetMap HTTPS pin that refreshes for 15 minutes, 1 hour, or 8 hours. Distinct from one-shot Геопозиция. LocalStore stays v6.
