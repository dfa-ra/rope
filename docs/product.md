...
- **0.3.51 UI:** 1:1 peer profile shows Звонок / Видео and reuses `startCall` / `startVideoCall`. Hidden for groups and Избранное. No CallVideoRenderer. LocalStore stays v6.
