...
Canonical trunk is `main`. Current product version is **0.3.5**. Do not retag or replace older release assets (`v0.2.15`, `v0.3.0`, `v0.3.1`, `v0.3.2`, `v0.3.3`, and `v0.3.4` stay published).
