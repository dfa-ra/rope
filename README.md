...
Canonical trunk is `main`. Current product version is **0.3.9**. Do not retag or replace older release assets (`v0.2.15`, `v0.3.0`, `v0.3.1`, `v0.3.2`, `v0.3.3`, `v0.3.4`, `v0.3.5`, `v0.3.6`, `v0.3.7`, and `v0.3.8` stay published).
