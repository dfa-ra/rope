...
| --- | --- | --- | --- | --- | --- |
| CG-007 | Unfreeze for this user task | PO | IN_PROGRESS | user 0.3.1 | CG-006 |
...
| CG-031 | Integrate Telegram UI + call fallback | ENG-LEAD/PO | IN_PROGRESS | this cycle | CG-030 |
