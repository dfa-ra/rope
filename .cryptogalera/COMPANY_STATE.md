...
Current product working branch: **`main`** (v0.3.45 install SSH PEM overwrite-unlink landed). Do not merge `cursor/ui-disappear-ae19`, `cursor/ui-silent-ae19`, `cursor/ui-polls-ae19`, `cursor/ui-attach-cam-ae19` (#64), `cursor/ui-folders-ae19`, `cursor/chat-archive-4f1f` (#75), `cursor/ui-global-search-0f6f` (#77), `cursor/sec-pat-host-ae19` (#78), `cursor/sec-health-ae19` (#79), `cursor/sec-info-ip-ae19` (#80), `cursor/sec-flag-ae19` (#81), or `cursor/ui-media-hub-0f6f` (#82) in this record.
