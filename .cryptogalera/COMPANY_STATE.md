...
User
 └── PO (this run; integrator)
      └── AND-01 — chat-list unread badge on cursor/unread-badge-882a
```

## Canonical git

- Default: **`main`** = tag `v0.3.11` (`8fb333db4fe81766d4c51b8dabb74c44fa9176d4`)
- Working: `cursor/unread-badge-882a`
- GitHub Release: https://github.com/dfa-ra/rope/releases/tag/v0.3.11
- Next ship: **v0.3.12** (do not retag v0.2.15 / v0.3.0 / v0.3.1 / v0.3.2 / v0.3.3 / v0.3.4 / v0.3.5 / v0.3.6 / v0.3.7 / v0.3.8 / v0.3.9 / v0.3.10 / v0.3.11)
